...
def read_values():
    ...
    front_accel = atan2(accelval['x'],accelval['z'])*180/3.14159 + GYRO_CORR_FRONT
    side_accel = atan2(accelval['y'],accelval['z'])*180/3.14159 + GYRO_CORR_SIDE

    return str(front_accel), str(side_accel)
